...
const Revenua = () => {
  ...
  const handleDate = async () => {
    try {
      ...
      // if(dateTo > Daynow()){
      //   toast.error("Ngày kết thúc phải nhỏ hơn ngày hiện tại");
      //   setBill(response.data.total_sum);
      //   setQuality(response.data.total_quantity);
      //   // setBills(response.data.data);
      //   return;
      ...
      <div className=" w-[100%]">
        ...
        <div className="">
          ...
          <div className=" grid grid-cols-4 gap-2 my-2 mx-2 ">
            <div
              onClick={fetchBook}
              className=" col-span-2 cursor-pointer py-4 bg-white rounded shadow-lg"
            >
        ...
        <div className=" mt-2 grid-cols-10 mx-2 grid gap-2 ">
          <h2 className=" col-span-10 bg-white text-gray-600 py-1 px-6 text-xl font-semibold  ">
            {" "}
            Sản phẩm bán được trong thời gian này{" "}
          </h2>
