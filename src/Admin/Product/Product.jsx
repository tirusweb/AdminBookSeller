      ...
      <div className=" w-[100%]">
        ...
        <div className="">
          <div className=" flex flex-1  w-full items-center justify-between bg-white shadow">
            ...
            <div onClick={handleShowCraete} className=" flex cursor-pointer items-center rounded-lg shadow-lg py-2 px-4 justify-start mr-[80px] bg-green-400">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
